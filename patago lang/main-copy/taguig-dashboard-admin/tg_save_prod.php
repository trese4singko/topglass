    ...
    foreach ($products as $product) {
        ...
        if (mysqli_num_rows($checkQuery) > 0) {
            ...
            $insertQuery = mysqli_query(
                $con,
                "INSERT INTO producttabletaguig (name, size, price, quantity_on_hand, category, status) VALUES 
            ...
            logtgActivity(
                ...
                'ADD',
                $newId,
                "Added new product: '$name' ($size), qty: $quantity_on_hand on Taguig Add Products"
            );
