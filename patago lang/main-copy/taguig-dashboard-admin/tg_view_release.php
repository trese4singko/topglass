...
if (isset($_GET['id'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        // Updated description to include more details
        $description = "Viewed customer '$customer_name' (ID: $customer_id) with order ID '$id' at Release Records (Taguig)";
        logActivity($con, $username, 'View Customer', $customer_id, $description); // Log the activity

        $description = "Viewed customer '$customer_name' (ID: $customer_id) with order ID '$id' at Release Records (Taguig)";
        logtgActivity($con, $username, 'View Customer', $customer_id, $description); // Log the activity
