  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <ul class="nav-list primary-nav">
        ...
        <li class="nav-item">
          <a href="?page=makati-act-history" class="nav-link ">
            <i class="fa-regular fa-clock"></i> <span class="nav-label">Makati Branch Activity</span>
          </a>
          <span class="nav-tooltip">Makati Branch Activity</span>
        </li>
  ...
  <div class="main">
    ...
    switch ($page) {
      ...
      case 'makati_products':
        include 'makati_prod_tbl.php';
        break;

      case 'makati_add_products_section':
        include 'makati_add_prod.php';
        break;

      case 'makati_release_products':
        include 'makati_release.php';
        break;
      ...
      case 'makati_ctm_records':
        include 'makati_records.php';
        break;

      case 'makati-act-history':
        include 'mkt_history_log.php';
        break;
