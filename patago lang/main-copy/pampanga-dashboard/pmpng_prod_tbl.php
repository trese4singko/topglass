...
$action = "Super Admin viewed on Pampanga Products";
...
<head>
    ...
    <link rel="stylesheet" href=" css/pampanga_prods.css"> <!-- Link to your CSS -->
    ...
    <script>
        function searchProducts() {
            ...
            for (let i = 1; i < rows.length; i++) {
                ...
                if (cells.length > 0) {
                    let productName = cells[0].textContent.toLowerCase(); // Column 1: Product Name
