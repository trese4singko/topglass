...
<head>
  ...
  <title>Pampanga Branch</title>

  <link rel="stylesheet" href="css/Pampanga_main.css">
...
<body>
  ...
  <div class="box">
    ...
    <div class="header-right sidebar-welcome ">
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <ul class="nav-list primary-nav">
        ...
        <li class="nav-item">
          <a href="?page=pampanga_products" class="nav-link ">
        ...
        <!-- <li class="nav-item">
          <a href="?page=pampanga_add_products" class="nav-link ">
        ...
        <!-- <li class="nav-item">
          <a href="?page=pampanga_release_products" class="nav-link ">
      ...
      <li class="nav-item">
          <a href="?page=pampanga-act-history" class="nav-link ">
            <i class="fa-regular fa-clock"></i> <span class="nav-label">Pampanga Logs</span>
          </a>
          <span class="nav-tooltip">Pampanga Logs</span>
        </li>
  ...
  <div class="main">
    ...
    switch ($page) {
      ...
      case 'pampanga_products':
        include 'pmpng_prod_tbl.php';
        break;

      case 'pampanga_add_products':
        include 'pmpng_add_prod.php';
        break;

      case 'pampanga_release_products':
  ...
  <script>
    function showNotification() {
      ...
      const personalDropdown = document.getElementById('personalDropdown');

      // Close other dropdowns if open
      if (chatDropdown.style.display === 'block') {
        chatDropdown.style.display = 'none';
      }
      if (personalDropdown.style.display === 'block') {
    ...
    function toggleDropdown() {
      ...
      // Toggle the personal dropdown
      personalDropdown.style.display = personalDropdown.style.display === 'block' ? 'none' : 'block';
    }
  </script>
  <script>
    function toggleDropdown() {
