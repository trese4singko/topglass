...
$action = "Super Admin on releasing a product from Taguig Releasing section";
...
<body>
        ...
        <div class="flex-container">
            ...
            <div class="container2">
                ...
                <div class="product-details">
                    ...
                    <span> Unit Measurement: <input type="text" id="inputProductSize"
                            placeholder="Ex: Size & Measurement">
                    </span>
    ...
    <script>
        $(document).ready(function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.status === "success") {
                            ...
                            logReleaseActivity(customerName, productName, quantity, totalPrice);
            ...
            function logReleaseActivity(customerName, productName, quantity, totalPrice) {
                $.ajax({
                    url: "log_activity.php",
                    type: "POST",
                    data: {
                        action: 'Release Item',
                        description: `Released product '${productName}' to customer '${customerName}' (Quantity: ${quantity}, Total Price: ₱${totalPrice})`
                    },
                    success: function (response) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.status === "success") {
                                ...
                                $("#quantityAvailabilityMessage").text("There is no available quantity left.");
