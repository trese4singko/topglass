...
<head>
  ...
  <link rel="stylesheet" href="taguig_cs/history.css">
...
<body>
  ...
  <div class="box">
    <div class="content" onclick="window.location.href='#';">
    ...
    <nav class="sidebar-nav">
      ...
      <li class="nav-item">
          <a href="?page=act-history" class="nav-link ">
            <i class="fa-regular fa-clock"></i> <span class="nav-label">Taguig Logs</span>
          </a>
          <span class="nav-tooltip">Taguig Logs</span>
        </li>
