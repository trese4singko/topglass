...
if (
    ...
    if ($updatequery) {
        $description = "Updated product '$productname' (ID: $eid) on Pampanga Edit Product";
        logActivity($con, $_SESSION['username'], 'Update Item', $eid, $description);
        logppgActivity($con, $_SESSION['username'], 'Update Item', $eid, $description);
