...
if (
    ...
    $checkQuery = mysqli_query($con, "SELECT * FROM  pampanga_main_product WHERE name='$name' AND size='$size' AND price='$price' AND category='$category'");
    if (mysqli_num_rows($checkQuery) > 0) {
        ...
        $updateQuery = mysqli_query($con, 
            "UPDATE  pampanga_main_product SET 
        ...
        $insertQuery = mysqli_query($con, 
            "INSERT INTO  pampanga_main_product VALUES 
