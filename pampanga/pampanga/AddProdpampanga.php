...
<head>  
    ...
    <link rel="stylesheet" href="css/add_product_pampanga.css">  
</head>  
<body>  
    <div class="bloom-container">  
       ...
       <div class="form">
            ...
            <div class="nova-input">  
                ...
                <input type="text" name="product-size" placeholder="Enter size" class="product-size" id="product-size"  >  
            </div> 
