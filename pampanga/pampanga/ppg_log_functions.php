<?php
function logppgActivity($con, $username, $action, $item_id = null, $description = '') {
    ...
    // Construct the query
    $query = "INSERT INTO ppg_activity_logs (username, action, item_id, description) 
    ...
    if (mysqli_query($con, $query)) {
        ...
        error_log("Error logging Pampanga activity: " . mysqli_error($con)); // Log error
        return false;
    }
}
?>