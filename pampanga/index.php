...
if (isset($_SESSION['userid']) && isset($_SESSION['session_token'])) {
    header("Location: pampanga/index.php");
    exit();
}
...
if (isset($_SESSION['userid']) && isset($_SESSION['session_token'])) {
    ...
    if (
        ...
        header("Location: pampanga/index.php?page=pampanga_dashboard");  // Adjust this path to your main page
        exit();
    }
}
...
<head>
    ...
    <link rel="stylesheet" href="pampanga/css/login.css">
    <link rel="shortcut icon" href="pampanga/img/side.png" type="image/x-icon">
    ...
    <div class="container">
        <div class="box">
            <div class="content">
                <div class="forimage">
                    <div class="logo">
                        <img src="pampanga/img/logo.png" alt="logo" class="logo">
                    </div>
                </div>
            ...
            fetch("login_process.php", {
                ...
                .then(data => {
                    if (data.status === "already_logged_in") {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Access Denied. This link is allowed for Makati admin/Employees only.',
                            text: data.message,
                        });
