...
if (isset($_SESSION['userid']) && isset($_SESSION['session_token'])) {
    ...
    if (
        ...
        header("Location: makati/index.php?page=makati_dashboard");  // Adjust this path to your main page
        exit();
    }
}
...
<head>
    ...
    <link rel="shortcut icon" href="makati/img/side.png" type="image/x-icon">
    ...
    <div class="container">
        <div class="box">
            <div class="content">
                <div class="forimage">
                    <div class="logo">
                        <img src="makati/img/logo.png" alt="logo" class="logo">
                    </div>
                </div>
