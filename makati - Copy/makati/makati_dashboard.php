...
$inventoryValueResult = mysqli_query($con, "SELECT SUM(price * quantity_on_hand) AS inventory_value FROM mkt_add_prod_data");
$inventoryValueRow = mysqli_fetch_assoc($inventoryValueResult);
$inventory_value = $inventoryValueRow['inventory_value'] ?? 0;

$lowStockResult = mysqli_query($con, "SELECT COUNT(*) AS low_stock FROM mkt_add_prod_data WHERE quantity_on_hand < 10");
...
<div class="main-cards">
    ...
    <div class="card4">
        <div class="card-inner">
            ...
            <h3>PERFORMANCE</h3>
            <p><?php echo $low_stock; ?> item(s) low in stock</p>
